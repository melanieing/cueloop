...
- 🎓 **첫 설치 onboarding** — 옵션 페이지에 12단계 시작하기 가이드 + 단축키 cheat sheet 자동 노출.
...
- 🎓 **First-run onboarding** — Options page opens automatically on install with a 12-step guide and the keyboard cheat sheet.
