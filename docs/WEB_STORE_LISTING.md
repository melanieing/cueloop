...
🎓 첫 설치 시 사용법 안내
확장을 처음 설치하면 옵션 페이지가 자동으로 열려서 12단계 시작하기 가이드를 보여줍니다. 단축키 cheat sheet도 함께.
...
On first install the options page opens automatically with a 12-step "Getting Started" guide and the keyboard cheat sheet, so you never have to wonder how to begin.
