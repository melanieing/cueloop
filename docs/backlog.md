...
- [x] **v0.2.3 게시 통과** ✅ — 블로그 자막 공유 섹션은 velog에 게시함.

> v0.2.2가 게시 통과한 상태라 0.2.3은 그 위에 얹는 일반 업데이트로 제출.

## v0.2.4 — 라인 복사 등 (2026-06-07 제출, 심사 대기)
...
- [x] **v0.2.5 zip 준비 완료** (2026-06-10) — `cueloop-0.2.5-chrome.zip`. version bump 0.2.4→0.2.5, manifest에 storage 권한 포함 확인. WEB_STORE_LISTING에 storage 정당화 추가.
